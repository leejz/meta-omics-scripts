...
extracts the top md5 hit for each scaffold based on the bit score and outputs a 
tab delimited table
...
--------------------------------------------------------------------------------
usage:   dereplicate_mgrast_md5.py -i mgrast_organism.txt -o output.file
"""
...
if __name__ == '__main__':
    parser = ArgumentParser(usage = "dereplicate_mgrast_md5.py -i \
mgrast_organism.txt -o output.file",
    ...
    with open(inputfilename,'U') as infile:
        for line in infile:
            ...
            md5 = query_list[1]
            if scaffold_dict[scaffold_name][1] < bit_score:
                scaffold_dict[scaffold_name] = [md5, bit_score] 
