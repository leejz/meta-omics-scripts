...
annotations.txt -o out.file",                  
    ...
    parser.add_argument("-i", "--input_file", action="store", dest="inputfilename",
                      help="text fasta file")
    parser.add_argument("-a", "--annotations_text", action="store", 
                      dest="annotationfilename",
                      help="tab-delimited annotations text file, first line headings, \
followed by entries for each sequence")
