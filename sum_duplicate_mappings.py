...
This script reads in a integrated metastranscriptomics mapping file and a file 
of duplicate reads and combines the duplicate records.  It combines the 
annotations, if they are identical, and appends if they are not.  It sums each 
RPKM value for each library as well.
...
--------------------------------------------------------------------------------
usage:   sum_duplicate_mappings.py -i mt.tab -f cluster.txt -o out.tab
"""
...
if __name__ == '__main__':
    parser = ArgumentParser(usage = "sum_duplicate_mappings.py -i mt.tab -f \
cluster.txt -o out.tab",
                            description=__doc__, 
                            formatter_class=RawDescriptionHelpFormatter)
    parser.add_argument("-i", "--input_filename", action="store", 
                        dest="inputfilename",
                        help="input tab delimited data file")
    parser.add_argument("-f", "--duplicates_filename", action="store", 
                        dest="dupfilename",
