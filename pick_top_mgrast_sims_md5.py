...
This script reads in a tab delimited file of mg-rast sims with md5 keys and 
extracts the (first) top md5 hit for each scaffold based on the e-value and 
outputs a tab delimited table
...
--------------------------------------------------------------------------------
usage:   pick_top_mgraast_sims_md5.py -i mgrast_organism.txt -e e_threshold -o output.file
"""
...
if __name__ == '__main__':
    parser = ArgumentParser(usage = "pick_top_mgraast_sims_md5.py -i mgrast_organism.txt -e e_threshold -o output.file",
                            description=__doc__, 
